...
} *av, *topo, *b, *c, *d, *e, *f, *g, *h, *i, *ex, *dx, *y, *x, *esquerda, *direita, *cima;
...
void Incluir_direita(int inc){	
			...
			if (topo->ponteiro_direita == NULL && valorzin>topo->valor){
				...
				if(ex->ponteiro_direita!=NULL){
					printf ("ex->valor %i",ex->valor);
					
					
				printf("ex->ponteiro direita %i", ex->ponteiro_direita->valor);
				}
				else{
					
				printf("ex->ponteiro direita NULL");
...
system("cls");
 ...
 x = y;
	...
	printf("\n");
			...
			printf("              2- ESQUERDA    |     ATUAL      |     DIREITA - 3");
			...
			printf(" Digite um valor entre 1 e 3 para navegar:|     ");
			scanf("%i",&optione);
		...
		case(1) :
			...
			if(cima->ponteiro_topo == NULL){
			
			printf("\n");
			printf("NAO eh POSSIVEL IR PARA TOPO POIS O MESMO eh NULLO");
			printf("\n");
			printf("\n");
		}
	
		else if(cima->ponteiro_topo != NULL){
		
		y = cima->ponteiro_topo;
...
void Excluir(int opcao){
	...
	//-----------------------------------------------------------------------------------------------		
			...
			else if(g->ponteiro_direita == NULL && g->ponteiro_esquerda != NULL){
				//1 FILHO na ESQUERDA
